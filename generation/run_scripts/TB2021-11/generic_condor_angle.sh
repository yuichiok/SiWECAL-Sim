...
#macfile=$4
macfile=grid_22angle_${particle}_${energy}GeV.mac
...
/gps/direction 0 0.37461 0.92718
/gps/pos/type Beam
/gps/pos/shape Circle
/gps/pos/centre 43.66 -40 0 mm
...
for physlist in ${physl[@]}; do
  for it in {1..20}; do
    ...
    label=${physlist}_conf${conf}_22angle_${particle}_${energy}GeV_${it}
    echo $label
